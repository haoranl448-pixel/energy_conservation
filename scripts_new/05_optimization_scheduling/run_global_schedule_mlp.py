...
OPT_DIR = Path("output/optimization/opt_results_mlp")
...
OUT_DIR     = Path("output/schedule/schedule_results_mlp"); OUT_DIR.mkdir(exist_ok=True)
SEG_OUT_DIR = OUT_DIR / "segments";      SEG_OUT_DIR.mkdir(exist_ok=True)
