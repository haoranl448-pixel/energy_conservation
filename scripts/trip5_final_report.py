...
OPT_DIR = Path(r"output/optimization/trip5_v2_6feat")
REPORT_DIR = Path(r"output/trip5_final_report")
...
def main():
    ...
    # 保存精细化 CSV
    report_path = REPORT_DIR / "Trip5_Detailed_Energy_Comparison.csv"
